//============================================================================
//  0x6F4A1CB0 - NIpse::CLrPathingSys::ReturnToStaticPool, vtable slot 1.
...
//  static pool (CLrPathingSys_GetStaticPool, Pathfinding/lrpath_staticpools.h).
//============================================================================
#include "pathfinesearch.h"
#include "lrpath_staticpools.h"

void CPathFineSearch::ReturnToStaticPool()
{
    void* pool = CLrPathingSys_GetStaticPool();
