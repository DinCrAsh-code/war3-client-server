//============================================================================
//  0x6F3BD950 - ResolveBoolExprHandle: turn a JASS `boolexpr` handle into the object
//  behind it, or null.
//
...
//  guess, because both of its constructor calls are 0x6F3B8C10, the 'bExp'
//  constructor (checkedboolexprslot.cpp).
//
...
SJassBoolExpr* __fastcall ResolveBoolExprHandle(int handle)
{
    ...
    SCheckedBoolExprSlot checked(candidate);
    ...
    if (validated)
        return (SJassBoolExpr*)checked.m_value;

    SCheckedBoolExprSlot fallback(0);
    return (SJassBoolExpr*)fallback.m_value;
}
