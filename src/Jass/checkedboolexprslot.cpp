//============================================================================
//  0x6F3B8C10 - SCheckedBoolExprSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F3B55C0`, so the two must not be in a position
...
SCheckedBoolExprSlot::SCheckedBoolExprSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
