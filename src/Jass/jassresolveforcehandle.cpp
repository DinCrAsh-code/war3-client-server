//============================================================================
//  0x6F3BD5F0 - ResolveForceHandle: turn a JASS `force` handle into the object
//  behind it, or null.
//
...
//  guess, because both of its constructor calls are 0x6F3B9900, the '+frc'
//  constructor (checkedforceslot.cpp).
//
...
SJassForce* __fastcall ResolveForceHandle(int handle)
{
    ...
    SCheckedForceSlot checked(candidate);
    ...
    if (validated)
        return (SJassForce*)checked.m_value;

    SCheckedForceSlot fallback(0);
    return (SJassForce*)fallback.m_value;
}
