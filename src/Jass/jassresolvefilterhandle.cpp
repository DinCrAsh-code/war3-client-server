//============================================================================
//  0x6F3BD830 - ResolveFilterHandle: turn a JASS `filter` handle into the object
//  behind it, or null.
//
...
//  guess, because both of its constructor calls are 0x6F3B8B00, the '+flt'
//  constructor (checkedfilterslot.cpp).
//
...
SJassBoolExpr* __fastcall ResolveFilterHandle(int handle)
{
    ...
    SCheckedFilterSlot checked(candidate);
