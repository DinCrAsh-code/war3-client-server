//============================================================================
//  0x6F3B8B00 - SCheckedFilterSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F3B6040`, so the two must not be in a position
...
SCheckedFilterSlot::SCheckedFilterSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
