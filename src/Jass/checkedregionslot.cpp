//============================================================================
//  0x6F3B8F40 - SCheckedRegionSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F3B6260`, so the two must not be in a position
...
SCheckedRegionSlot::SCheckedRegionSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
