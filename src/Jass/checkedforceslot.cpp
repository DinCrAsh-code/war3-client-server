//============================================================================
//  0x6F3B9900 - SCheckedForceSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F3B6F00`, so the two must not be in a position
...
SCheckedForceSlot::SCheckedForceSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
