//============================================================================
//  0x6F095D70 - SCheckedFogModifierSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F085DC0`, so the two must not be in a position
...
SCheckedFogModifierSlot::SCheckedFogModifierSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
