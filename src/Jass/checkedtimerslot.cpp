//============================================================================
//  0x6F34BEA0 - SCheckedTimerSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F33EB40`, so the two must not be in a position
...
SCheckedTimerSlot::SCheckedTimerSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
