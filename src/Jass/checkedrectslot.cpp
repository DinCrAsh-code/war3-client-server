//============================================================================
//  0x6F3B9180 - SCheckedRectSlot's constructor (agenttypedslots.h).
//
//  Own translation unit, separate from its own Assign: the constructor
//  issues a genuine `call sub_6F3B6500`, so the two must not be in a position
...
SCheckedRectSlot::SCheckedRectSlot(CAgent* candidate)
{
    m_value = 0;
    __try
    {
