# Function summary: sub_408D70 (0x00408D70)
...
### sub_40BED0 [FindResourceEntryByParam] (0x0040BED0) - call at 0x00408E54
...
### sub_40F3D0 [RtsManager::UpgradeComponent] (0x0040F3D0) - call at 0x00408E9C

- Prototype: `bool __fastcall RtsManager::UpgradeComponent(void *this_ebx, int edx_unused, int componentIndex_eax)`
- Summary: Validates and advances a specific component level within an RTS manager object, optionally instantiating or updating the underlying component instance via the component factory.

### sub_408CE0 [CalculateGridCoordinatesOrMapping] (0x00408CE0) - call at 0x00408EEC

- Prototype: `void __cdecl sub_408CE0()`
- Summary: Calculates coordinate mapping or grid indices using an integer square root approximation loop followed by floating-point arithmetic operations.

### sub_40DAC0 [ProcessEntityInteractionOrCommand] (0x0040DAC0) - call at 0x00408F15
...
0x00408E54  call sub_40BED0                              ; -> sub_40BED0 [FindResourceEntryByParam]
...
0x00408E9C  call sub_40F3D0                              ; -> sub_40F3D0 [RtsManager::UpgradeComponent]
...
0x00408EEC  call sub_408CE0                              ; -> sub_408CE0 [CalculateGridCoordinatesOrMapping]
...
0x00408F15  call sub_40DAC0                              ; -> sub_40DAC0 [ProcessEntityInteractionOrCommand]
