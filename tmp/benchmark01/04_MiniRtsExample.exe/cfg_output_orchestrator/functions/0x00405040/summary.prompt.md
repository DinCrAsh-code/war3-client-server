# Function summary: sub_405040 (0x00405040)
...
### sub_404EA0 [Entity::ProcessStateTransitionOrAction] (0x00404EA0) - call at 0x004050CE

- Prototype: `bool __fastcall Entity::ProcessStateTransitionOrAction(void *pEntity, void *edx_unused, const unsigned char *pConfigData)`
- Summary: Evaluates a configuration command/action byte array against entity state attributes and dispatches corresponding actions or updates state flags.
...
0x004050CE  call sub_404EA0                              ; -> sub_404EA0 [Entity::ProcessStateTransitionOrAction]
