# Function summary: sub_404AD0 (0x00404AD0)
...
### sub_402E50 [FindNearestValidEntityInRadius] (0x00402E50) - call at 0x00404B3A, 0x00404CC8
...
### sub_4046B0 [DispatchCommandPacket] (0x004046B0) - call at 0x00404BFB, 0x00404C48
...
### sub_402A30 [FindEntityInRange] (0x00402A30) - call at 0x00404C1F

- Prototype: `void* __stdcall FindEntityInRange(float x, float y)`
- Summary: Iterates through a global list of entities, checks their active state, distance to a specified 2D coordinate, and grid/pathfinding constraints, returning the first matching entity pointer or NULL.

### sub_405110 [CheckAndExecuteUnitAbility] (0x00405110) - call at 0x00404CB5
...
### sub_404DF0 [CheckEntityConditionsOrCount] (0x00404DF0) - call at 0x00404D00
...
### sub_405300 [Entity::TryPerformActionOrCommand] (0x00405300) - call at 0x00404D10
...
0x00404B36  fstp
0x00404B39  push eax
0x00404B3A  call sub_402E50                              ; -> sub_402E50 [FindNearestValidEntityInRadius]
...
0x00404BFB  call sub_4046B0                              ; -> sub_4046B0 [DispatchCommandPacket]
...
0x00404C1B  fstp
0x00404C1E  push eax
0x00404C1F  call sub_402A30                              ; -> sub_402A30 [FindEntityInRange]
...
0x00404C48  call sub_4046B0                              ; -> sub_4046B0 [DispatchCommandPacket]
...
0x00404CB3  push eax
0x00404CB4  push edi
0x00404CB5  call sub_405110                              ; -> sub_405110 [CheckAndExecuteUnitAbility]
0x00404CBA  fld                                          ; -> 0x0041D2B8 in .rdata
0x00404CC0  push ecx
0x00404CC1  lea eax, [edi+34h]
0x00404CC4  fstp
0x00404CC7  push eax
0x00404CC8  call sub_402E50                              ; -> sub_402E50 [FindNearestValidEntityInRadius]
...
0x00404CFE  push esi
0x00404CFF  push edi
0x00404D00  call sub_404DF0                              ; -> sub_404DF0 [CheckEntityConditionsOrCount]
0x00404D05  movzx edx, word ptr [ebx+esi*2+76h]
0x00404D0A  add eax, edx
0x00404D0C  jnz loc_404D15
0x00404D0E  push 1
0x00404D10  call sub_405300                              ; -> sub_405300 [Entity::TryPerformActionOrCommand]
0x00404D15  pop edi
0x00404D16  pop esi
0x00404D17  pop ebx
