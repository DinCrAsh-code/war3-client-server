# Function summary: sub_409280 (0x00409280)
...
### sub_419180 [DecompressLZSS] (0x00419180) - call at 0x00409322

- Prototype: `int __cdecl DecompressLZSS(const void *src, int srcSize)`
- Summary: Decompresses an LZSS-encoded data stream into a fixed 8KB global history buffer (`byte_42ACC8`), returning the decompressed size on success or 0 on error/overflow.

### memcpy (0x0041A22A) - call at 0x00409334

- Summary: Import thunk: jumps straight to the imported API MSVCR80!memcpy.

### sub_418A60 [CalculateCrc32] (0x00418A60) - call at 0x0040934B
...
0x00409322  call sub_419180                              ; -> sub_419180 [DecompressLZSS]
...
0x0040934B  call sub_418A60                              ; -> sub_418A60 [CalculateCrc32]
