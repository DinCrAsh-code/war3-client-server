# Function summary: sub_409460 (0x00409460)
...
- Address: 0x00409460
- Name: sub_409460 (auto-generated placeholder)
- Size: 28 bytes, 13 instructions
- One call chain from the analysis root down to it: _main -> sub_401750 -> sub_40A0D0 -> sub_409940 -> sub_409460

## How callers use this function

### From sub_409940 (0x00409940) - call at 0x00409F25
...
```asm
0x00409460  push ecx
0x00409461  cmp byte ptr [eax], 2
0x00409464  jnz loc_409471
0x00409466  fld
0x00409469  fstp
0x0040946C  fld
0x0040946F  pop ecx
