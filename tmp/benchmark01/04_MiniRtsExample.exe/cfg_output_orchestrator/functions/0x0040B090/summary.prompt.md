# Function summary: sub_40B090 (0x0040B090)
...
- Address: 0x0040B090
- Name: sub_40B090 (auto-generated placeholder)
- Size: 34 bytes, 10 instructions
- One call chain from the analysis root down to it: _main -> sub_401750 -> sub_40A0D0 -> sub_409940 -> sub_40B090

## How callers use this function

### From sub_409940 (0x00409940) - call at 0x00409ECA; vtable entry: slot 28 of vtable 0x0041D228, vtable used at 0x00409EAC
...
```asm
0x0040B090  sub esp, 8
0x0040B093  mov eax, dword_42AC60                        ; -> 0x0042AC60 in .data
0x0040B098  mov eax, [eax+5BBBCh]
0x0040B09E  mov ecx, [esp+8+arg_C]
0x0040B0A2  mov byte ptr [esp+8+var_8], 1
0x0040B0A6  mov edx, [esp+8+var_8]
0x0040B0A9  mov [ecx], edx
0x0040B0AB  mov [ecx+4], eax
0x0040B0AE  add esp, 8
0x0040B0B1  retn
```
