# Function summary: sub_40AD00 (0x0040AD00)
...
- It is part of a mutually recursive cycle - these functions all (directly or indirectly) call each other: sub_40A0D0 (0x0040A0D0), sub_409940 (0x00409940), sub_419280 [EnqueueStateEntry] (0x00419280), sub_40A1E0 [DispatchEntityEvent] (0x0040A1E0).
...
### sub_419280 [EnqueueStateEntry] (0x00419280) - call at 0x0040ADAA

- Prototype: `int __stdcall EnqueueStateEntry(void *state_container, int arg1, int arg2, int arg3, int arg4)`
- Summary: Allocates or inserts a new element into a state/priority queue container, resizes the container if capacity is exceeded, populates the new entry with provided data and flags, and restores heap order using a sift-up routine.
...
0x0040ADAA  call sub_419280                              ; -> sub_419280 [EnqueueStateEntry]
