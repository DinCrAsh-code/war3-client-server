# Function summary: sub_40A2A0 (0x0040A2A0)
...
- Address: 0x0040A2A0
- Name: sub_40A2A0 (auto-generated placeholder)
- Size: 42 bytes, 12 instructions
- One call chain from the analysis root down to it: _main -> sub_401750 -> sub_40A0D0 -> sub_409940 -> sub_40A2A0

## How callers use this function

### From sub_409940 (0x00409940) - call at 0x00409ECA; vtable entry: slot 0 of vtable 0x0041D228, vtable used at 0x00409EAC
...
```asm
0x0040A2A0  sub esp, 8
0x0040A2A3  mov eax, dword_42AC60                        ; -> 0x0042AC60 in .data
0x0040A2A8  fld
0x0040A2AE  mov eax, [esp+8+arg_C]
0x0040A2B2  fstp
0x0040A2B6  mov edx, [esp+8+var_4]
0x0040A2BA  mov byte ptr [esp+8+var_8], 2
0x0040A2BE  mov ecx, [esp+8+var_8]
0x0040A2C1  mov [eax], ecx
0x0040A2C3  mov [eax+4], edx
0x0040A2C6  add esp, 8
0x0040A2C9  retn
```
