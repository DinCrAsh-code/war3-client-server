# Function summary: sub_403320 (0x00403320)
...
### sub_417D70 [EvaluateGridLookup] (0x00417D70) - call at 0x0040338B

- Prototype: `int __cdecl EvaluateGridLookup(const void *dataPtr)`
- Summary: Performs a 2D grid or lookup-table index calculation using floating-point coordinates and bounds clamping, then checks a bit within a data structure.
...
0x0040338A  push eax
0x0040338B  call sub_417D70                              ; -> sub_417D70 [EvaluateGridLookup]
0x00403390  pop edi
0x00403391  pop ebx
0x00403392  retn
0x00403393  pop edi
