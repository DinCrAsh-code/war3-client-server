# Function summary: sub_4071C0 (0x004071C0)
...
### sub_40C950 [ValidateEntityCriteriaFilter] (0x0040C950) - address taken at 0x00407205, 0x004074E1
...
### sub_4177F0 [SpatialGridQueryEntities] (0x004177F0) - call at 0x0040722F, 0x0040750F
...
### sub_417F80 [CalculateDistance] (0x00417F80) - call at 0x00407372, 0x0040747E, 0x004077B8, 0x004077EF
...
### sub_4046B0 [DispatchCommandPacket] (0x004046B0) - call at 0x0040742E, 0x00407737, 0x00407976
...
### sub_417FD0 [Vec3_NormalizeOrZero] (0x00417FD0) - call at 0x004078A9
...
### sub_4183C0 [CheckRaySegmentCollisionOrDistance] (0x004183C0) - call at 0x00407902

- Prototype: `bool __fastcall CheckRaySegmentCollisionOrDistance(void *this, void *edx_param)`
- Summary: Performs a 2D geometric test by calling a ray/segment intersection routine and evaluating vector dot products or squared distances to determine a boolean outcome (such as line-of-sight obstruction or distance threshold validation).
...
0x00407204  push ecx
0x00407205  push offset sub_40C950                       ; -> sub_40C950 [ValidateEntityCriteriaFilter]
0x0040720A  push ecx
...
0x0040722F  call sub_4177F0                              ; -> sub_4177F0 [SpatialGridQueryEntities]
...
0x00407372  call sub_417F80                              ; -> sub_417F80 [CalculateDistance]
0x00407377  fcomp
...
0x0040742E  call sub_4046B0                              ; -> sub_4046B0 [DispatchCommandPacket]
0x00407433  pop edi
0x00407434  pop esi
0x00407435  pop ebp
0x00407436  pop ebx
...
0x0040747E  call sub_417F80                              ; -> sub_417F80 [CalculateDistance]
0x00407483  fcomp
...
0x004074E0  push eax
0x004074E1  push offset sub_40C950                       ; -> sub_40C950 [ValidateEntityCriteriaFilter]
0x004074E6  push ecx
...
0x0040750F  call sub_4177F0                              ; -> sub_4177F0 [SpatialGridQueryEntities]
0x00407514  fld
...
0x00407737  call sub_4046B0                              ; -> sub_4046B0 [DispatchCommandPacket]
0x0040773C  pop edi
0x0040773D  pop esi
0x0040773E  pop ebp
0x0040773F  pop ebx
...
0x004077B8  call sub_417F80                              ; -> sub_417F80 [CalculateDistance]
0x004077BD  fcomp
...
0x004077EF  call sub_417F80                              ; -> sub_417F80 [CalculateDistance]
0x004077F4  fcomp
...
0x004078A2  fsub
0x004078A5  fstp
0x004078A9  call sub_417FD0                              ; -> sub_417FD0 [Vec3_NormalizeOrZero]
0x004078AE  fld
...
0x00407902  call sub_4183C0                              ; -> sub_4183C0 [CheckRaySegmentCollisionOrDistance]
...
0x00407976  call sub_4046B0                              ; -> sub_4046B0 [DispatchCommandPacket]
0x0040797B  pop edi
0x0040797C  pop esi
0x0040797D  pop ebp
0x0040797E  pop ebx
